...
from web_scraping_agent.tools import web_scraping_tool
...
vod_formatting_agent = Agent(
    ...
    description='Your main task is to filter and format the VOD result according to the given output schema.',
...
root_agent  = Agent(
    ...
    description = 'Extracts stream options from the provided URL using the tool',
